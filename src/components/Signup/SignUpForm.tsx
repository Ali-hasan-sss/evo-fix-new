...
const SignUpForm = () => {
  ...
  const signUpSubmitHundler = async (e: React.FormEvent) => {
    e.preventDefault();
    if (email === "") return toast.error("هناك حقل فارغ");
    if (fullName === "") return toast.error("هناك حقل فارغ");
    if (password === "") return toast.error("هناك حقل فارغ");
    ...
    <div className="mx-auto max-w-[500px] rounded bg-white px-6 py-10 shadow-three dark:bg-dark sm:p-[60px]">
      ...
      <div className="mb-8 flex items-center justify-center">
        ...
        <p className="w-full px-5 text-center text-base font-medium text-body-color">
          أو، إنشاء حساب عبر الإيميل
        </p>
        <span className="hidden h-[1px] w-full max-w-[60px] bg-body-color/50 sm:block"></span>
      </div>
      <form onSubmit={signUpSubmitHundler}>
        <div className="mb-8">
          <label
            htmlFor="name"
        ...
        <div className="mb-8">
          ...
          >
            {governorates.map((governorate) => (
              <AutocompleteItem key={governorate.id} value={governorate.value}>
                {governorate.value}
              </AutocompleteItem>
            ))}
          </Autocomplete>
        ...
        <div className="mb-8">
          ...
          <textarea
            ...
            rows={5}
            placeholder="أدخل عنوان سكنك بالتفصيل"
        ...
        <div className="mb-8 flex">
          ...
          >
            ...
            <span>
              إنشائك الحساب يدل على أنك موافق على الشروط والأحكام وسياسة
              الخصوصية
            </span>
          </label>
        </div>
