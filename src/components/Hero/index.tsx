...
const Hero = () => {
  ...
  const complaintSubmitHundler = async (e: React.FormEvent) => {
    e.preventDefault();
    if (message === "") return toast.error("هناك حقل فارغ");
    
    try {
      await axios.post(`${DOMAIN}/api/complaints`, { message });
      router.replace("/");
      toast.success("شكراً لك، تم إرسال الشكوى")
      router.refresh()
    } catch (error: any) {
      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full items-center px-4 pt-7">
              <div className="hero absolute left-[50%] top-[50%] mx-auto max-w-[800px] translate-x-[-50%] translate-y-[-50%] text-center">
                <h1 className="mb-5  text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  منصة <span className="text-primary">EvoFix</span> ترحب بكم
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  ...
                  كما أننا نقدر وقتك. بمجرد استلام طلب الصيانة، يتم تحديد موعد
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                    <Button
                      className="rounded-md px-8 py-7 hover:opacity-50"
                      onPress={onOpen}
                    >
                      تقديم شكوى
                    </Button>
                      ...
                      {(onClose) => (
                        <>
                          ...
                          <ModalFooter>
                            ...
                            <Button  color="primary" onClick={complaintSubmitHundler}>
                              إرسال
                            </Button>
                          </ModalFooter>
                        </>
        ...
        {/* <div className="absolute  -bottom-40 -left-32  z-[-1] opacity-30 lg:opacity-100">
          <svg
            width={400}
            height={400}
            fill="none"
